...
- 2.23～2.25 使用原 fastbin 路径。
- 2.26～2.27 改为 count=3 tcache 链，并用 calloc 处理 exact-size unsorted victim。
- 2.28 的 bdc3009 `bck->fd==victim` 检查切断 hook 投递。
- 2.34 又删除 malloc/free hooks。
